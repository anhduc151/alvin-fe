...
# Company: Tekup JSC
# Phone: 0333 365 777
# This file will help stop docker-compose service only
...
then
  ...
  echo "Please create .env.dev file in root folder project at: ${SCRIPT_ROOT_DIR}"
  exit 1
fi

echo "This file will help stop docker-compose service only"
